...
from ..models import Book, Library, BookStatus
...
class UpdateViewTests(TestCase):
    ...
    def test_update_all_fields_except_isbn(self):
        # Submit the form with updated data
        updated_data = create_book('Blood bond', date(2017, 3, 3), self.book2.isbn,
                        10, 150, 300, self.book2.author.pk, self.book2.library.pk, 
