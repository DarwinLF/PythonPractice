...
class LibraryModelTests(TestCase):
    ...
    def test_valid_rnc(self):
        library1 = Library(name='libreria1', location='Tenares', rnc='402-3070960-8')
        library2 = Library(name='libreria2', location='Tenares', rnc='40230709608')
        library3 = Library(name='libreria3', location='Tenares', rnc='402-30709608')
        library4 = Library(name='libreria4', location='Tenares', rnc='4023070960-8')
